...
export const PROJECTS: IProject[] = [
    ...
    },
    {
        ...
        description: 'Детската градина разраства своята дейност и търси визия, която да отговаря на темата й на развитие.',
    ...
    },
    {
        ...
        description: 'Логото е изградено от два елемента, единият е типографски - малката буква "ни" от гръцката азбука, а другият е визуален - птицата "Трънковче" от разред "Врабчоподобни". Формите са плътни и овални, за да внушават стабилност и завършеност, както и гъвкавост.',
